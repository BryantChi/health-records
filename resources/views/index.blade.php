                    ...
                    <form action="{{ route('health-records.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" class="form-control" name="health-water"
                                id="health-water" placeholder="喝水量" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" min="0" class="form-control" name="health-defecation-count"
                                id="health-defecation-count" placeholder="排便次數" required>
                        </div>
                        <div class="mb-3">
