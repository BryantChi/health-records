                ...
                <div class="px-3 py-5">
                    <form action="{{ route('health-records.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ $healthRecordsInfo['health-breakfast-img']}}" id="health-breakfast-img-display" class="img-thumbnail" width="300" alt="">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="{{ $healthRecordsInfo['health-dinner-img']}}" id="health-dinner-img-display" width="300" class="img-thumbnail" alt="">
                        </div>
                        <div class="mb-3">
                            ...
                            <img src="{{ $healthRecordsInfo['health-bedtime-snacks-img']}}" id="health-bedtime-snacks-img-display" class="img-thumbnail" width="300" alt="">
                        </div>
                        <div class="mb-3">
